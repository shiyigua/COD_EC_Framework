...
uint8_t USART6_RxFrameBuff[6];

void myprintf(int16_t value1,int16_t value2)
{
	USART6_RxFrameBuff[0] = 0xAA;
	USART6_RxFrameBuff[1] = 0xBB;
	USART6_RxFrameBuff[2] = (uint8_t)(value1 >> 8);
	USART6_RxFrameBuff[3] = (uint8_t)(value1);
	USART6_RxFrameBuff[4] = (uint8_t)(value2 >> 8);
	USART6_RxFrameBuff[5] = (uint8_t)(value2);
	
	HAL_UART_Transmit_DMA(&huart6,USART6_RxFrameBuff,6);
}
